                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?= site_url('Updatesampah/hapus/') ?>" method="post">
                                        ...
                                        <a href=" <?= site_url('Updatesampah/edit/' . $ush->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil small"></i>Update</a> <button onclick="javascript: return confirm('Anda Yakin Hapus?')" class="btn btn-sm btn-danger"><i class="fa fa-trash small"></i>Delete</button>
                                    </form>
                                </td>
                            </tr>
